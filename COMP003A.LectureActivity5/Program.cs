 ...
 * Course: COMP-0033A
 * Purpose: Code for Leacture Activity 5
 */
...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Donald Knuth"); //call the HelloWorld(string name) again with a different parmeter value
            ...
            HelloWorld("Charels Babbage", DateTime.Now.Year - 1791); // call to HelloWorld(string name, int inputAge) again

            Console.WriteLine("\n");
            Console.WriteLine("Enther value for inputNumber1: ");
